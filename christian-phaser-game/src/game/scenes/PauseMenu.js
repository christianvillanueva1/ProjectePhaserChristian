export class PauseMenu {
    constructor(scene) {
      ...
      this.continueButton = scene.add
        .rectangle(scene.cameras.main.width / 2, 300, 300, 60, 0x00aa00)
        .setScrollFactor(0)
        .setDepth(101)
        .setInteractive()
        .setVisible(false)
      ...
      this.restartButton = scene.add
        .rectangle(scene.cameras.main.width / 2, 380, 300, 60, 0x0088ff)
        .setScrollFactor(0)
        .setDepth(101)
        .setInteractive()
        .setVisible(false)
      ...
      this.restartText = scene.add
        .text(scene.cameras.main.width / 2, 380, "REINICIAR NIVEL", {
          fontFamily: "Arial Black",
          fontSize: 24,
          color: "#ffffff",
          align: "center",
      ...
      this.exitButton = scene.add
        .rectangle(scene.cameras.main.width / 2, 540, 300, 60, 0xaa0000)
        .setScrollFactor(0)
        .setDepth(101)
        .setInteractive()
        .setVisible(false)
